...
(function () {
  ...
  // ---- Nova Voice bridge: let nova-voice.js broadcast TTS on the live channel.
  window.NovaRadio = {
    isLive: function () { try { return !!(PTT.talk && PTT.talk.room); } catch (e) { return false; } },
    talkRoom: function () { try { return PTT.talk ? PTT.talk.room : null; } catch (e) { return null; } },
    currentChannel: function () { try { return PTT.talk ? PTT.talk.channel : null; } catch (e) { return null; } }
  };
})();
